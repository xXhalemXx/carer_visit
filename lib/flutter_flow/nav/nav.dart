...
GoRouter createRouter(AppStateNotifier appStateNotifier) {
  $power_sync_b0w5r9.initializeRoutes(
    homePageWidgetName: 'power_sync_b0w5r9.HomePage',
  ...
  return GoRouter(
    ...
    routes: [
      ...
      FFRoute(
        name: VisitDetailsWidget.routeName,
        path: VisitDetailsWidget.routePath,
        builder: (context, params) => VisitDetailsWidget(
          singleVisit: params.getParam<VisitsRow>(
            'singleVisit',
      ...
      FFRoute(
        name: $power_sync_b0w5r9.HomePageWidget.routeName,
        path: $power_sync_b0w5r9.HomePageWidget.routePath,
        builder: (context, params) => $power_sync_b0w5r9.HomePageWidget(),
      )
