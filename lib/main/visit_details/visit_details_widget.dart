...
class VisitDetailsWidget extends StatefulWidget {
  const VisitDetailsWidget({
    super.key,
    required this.singleVisit,
  });

  final VisitsRow? singleVisit;

  static String routeName = 'visitDetails';
  static String routePath = '/visitDetails';
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      power_sync_b0w5r9_util.wrapWithModel(
                        model: _model.powerSyncQueryModel,
                        ...
                        child: power_sync_b0w5r9.PowerSyncQueryWidget(
                          ...
                          child: (List<dynamic> rows) => NoteWidget(
                            allNotes:
                                functions.supabaseRowsToNotes(rows.toList())!,
                          ),
                        ),
                      ),
                    ].divide(SizedBox(height: 16.0)),
